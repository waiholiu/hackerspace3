...
ActiveRecord::Schema.define(version: 2020_06_27_102638) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["education"], name: "index_users_on_education"
    t.index ["email"], name: "index_users_on_email", unique: true
    t.index ["employment"], name: "index_users_on_employment"
    t.index ["first_peoples"], name: "index_users_on_first_peoples"
